...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/TeamsFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/BaseFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TeamsFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\UsersFixtures(), 'groups' => []]]);
